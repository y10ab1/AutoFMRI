...
def get_args():
    ...
    args.add_argument('--stage1_model', type=str, default='rf', help='Specify the stage 1 model', choices=['rf', 'rfr', 'cu_rf', 'cu_rfr', 'svm', 'svr', 'cnn'])
    args.add_argument('--stage2_model', type=str, default='rf', help='Specify the stage 2 model', choices=['rf', 'rfr', 'cu_rf', 'cu_rfr', 'svm', 'svr', 'cnn'])
